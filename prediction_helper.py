...
model_young = joblib.load("Health/model_young.joblib")
model_rest = joblib.load("Health/model_rest.joblib")
scaler_young = joblib.load("Health/scaler_young.joblib")
scaler_rest = joblib.load("Health/scaler_rest.joblib")
...
def predict(input_dict):
    ...
    # Return prediction in percentage format
    return int(prediction[0])  # Modify this if needed for percentage calculation
